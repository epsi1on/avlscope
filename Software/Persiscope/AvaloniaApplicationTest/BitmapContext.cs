 ...
 struct BitmapContext 
    {
      ...
      private readonly int _backBufferStride;
        ...
        public void SetPixeli(int index, int color)
        {
            //using (var context = bmp.GetBitmapContext())
            ...
            unsafe{
                ...
                var sp = new Span<int>(_backBuffer.ToPointer(), 1000);
                
                var pixels = (int*)_backBuffer;
        ...
        public BitmapContext(ILockedFramebuffer writeableBitmap, ReadWriteMode mode)
        {
           ...
           // BitmapContextBitmapProperties bitmapProperties;
            ...
            { 
                ...
                */
                ...
                _backBufferStride = writeableBitmap.RowBytes;
                _pixelWidth = writeableBitmap.Size.Width;
                _pixelHeight = writeableBitmap.Size.Height;
                //_format = writeableBitmap.Format;
                _backBuffer = writeableBitmap.Address;
                
                //double width = _backBufferStride / BitmapContextExtensions.SizeOfArgb;
